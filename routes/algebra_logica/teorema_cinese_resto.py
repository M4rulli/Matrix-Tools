...
# Tutti i messaggi d’errore contengono LaTeX racchiuso tra \( … \) così
# il frontend può renderizzarli con MathJax.
...
def teorema_cinese_resto():
    ...
    try:
        ...
        # Step 2: sistema semplificato + forma cinese
        ...
        if chinese:
            ...
            # Manteniamo solo quelle con inversa per mostrare eventuale sottosistema
        ...
        if chinese:
            ...
            # --- Step 4: risolvi le congruenze N_i y_i ≡ 1 (mod n_i) ----------
            align_y = []
            yi_list = []
            for idx, (Ni, mi) in enumerate(zip(Ni_values, mod_list), 1):
            ...
            # --- Step 5: combinazione lineare per una soluzione particolare ---
